...
export class ComputerManager {
    ...
    editComputer(index: number, computer: Computer) {
        return this.listComputers[index].id = computer.;
    }
    ...
    payBill(index: number) {
        ...
        let sum = (newTime.getSeconds() - this.listComputers[index].time.getSeconds()) * this.priceHour + this.listComputers[index].moneyService;
        return sum;
    }
