...
function addComputer() {
    ...
    console.log(displayComp(cyberGame.showAllComputers()));
    // console.log(`--------------------------Nhập id máy mới--------------------------`);
    // let id = +input.question('Nhap id may: ');
    // console.log(displayComp(cyberGame.showAllComputers()));
    // let flag = true;
    // do {
    //     let str = cyberGame.showAllComputers().filter(value => value.id === id);
    //     if (str.length > 0) {
    //         flag = false;
    //         console.log(`-----------Id máy bị trùng, yêu cầu tạo lại-----------`);
    //         id = input.question('Nhap id may: ');
    //         // addComputer();
