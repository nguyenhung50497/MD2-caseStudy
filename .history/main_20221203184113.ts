    ...
    do {
        ...
        if (choice === 0) {
            ...
            if (id >= listComputers.length) {
                ...
                let obj: Computer = cyberGame.showAllComputers()[choice-1];
                cyberGame.showAllComputers()[choice-1] = 
                for (let i = 0; i < listComputers.length; i++) {
                    if (listComputers[i].id === id) {
                        obj = listComputers[i];
                        cyberGame.showAllComputers()[i] = newComputer;
                        cyberGame.showAllComputers()[choice-1] = obj;
                        break;
                    }
                }
            }
