...
let may1 = new Computer('May 1', 'offline', new Date(), 0, 0);
let may2 = new Computer('May 2', 'online', new Date(), 3, 6);
let may3 = new Computer('May 3', 'offline', new Date(), 0, 0);
let may4 = new Computer('May 4', 'offline', new Date(), 0, 0);
let may5 = new Computer('May 5', 'online', new Date(), 5, 10);
...
function addComputer() {
    ...
    let newComputer = new Computer(name, 'offline', new Date(), 0, 0);
...
function editComputer() {
    ...
    do {
        ...
        if (choice === 0) {
            ...
            let newComputer = new Computer(name, computer.status, computer.time, computer.hours, computer.totalMoney);
...
function payBill() {
    ...
    do {
        ...
        if (choice === 0) {
            ...
            let sum = (newTime.getTime() - computer.time.getTime()) /100  2 + computer.totalMoney;
            console.log(newTime.getTime() - computer.time.getTime());
            ...
            cyberGame.showAllComputers()[choice-1].totalMoney = 0;
        ...
        if (choice === 0) {
            ...
            for (let i = 0; i < serviceManager.showAllServices().length; i++) {
                ...
                if (choice2 === 0) {
                    ...
                    cyberGame.showAllComputers()[choice-1].totalMoney += newService.price;
                    buyService();
                    break;
                }
            } while (choice !== 0)
